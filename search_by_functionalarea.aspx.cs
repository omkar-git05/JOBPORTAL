...
public partial class search_by_functionalarea : System.Web.UI.Page
{
    ...
    public void post()
    {
        ...
        string query = "select * from Post1 where Post1.area_id=" + DropDownList1.SelectedValue;
        adp = new SqlDataAdapter(query, con);
        DataSet ds = new DataSet();
        adp.Fill(ds);

        DropDownList2.DataSource = ds.Tables[0];
        DropDownList2.DataTextField = "post_name";
        DropDownList2.DataValueField = "post_id";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string query = "select * from Job_post where post_id=" + DropDownList2.SelectedValue;
