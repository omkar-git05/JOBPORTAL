...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark  bg-dark">
      <a class="navbar-brand" href="#"><h3 class="font-weight-bold">JobPortal <small class="text-muted font-italic"> Admin </small></h3></a>
      <div class="nav navbar">
        ...
        <h3 class="font-weight-bolder"> Admin Login </h3>
        <br />
        <div class="form-group">
            <h4> User Name</h4>
