...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark  bg-dark">
      ...
      <div class="nav navbar">
        ...
        <h3 class="font-weight-bolder"> Recruiter Login </h3>
        <br />
        <div class="form-group">
            <h4> User Name</h4>
        ...
        <div>
            <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="#6699FF" NavigateUrl="~/recruiter_regi.aspx">Registration</asp:HyperLink>
            <br />
            <br />
        </div>
        </div>
